...
extraEnvVars:
  ...
  - name: scala_dependency_2 
    value: "org.mongodb.spark:mongo-spark-connector_2.12:10.2.0"
...
web:
  ...
  image:
    registry: docker.io
    repository: peoplesjwilson/streaming-pipeline
    tag: custom-airflow-webserver
    digest: ""
